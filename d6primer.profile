...
function d6primer_profile_tasks(&$task, $url) {
  ...
  // Run 'task_configure_variables' task
...
function configure_captcha() {
  ...
  variable_set('recaptcha_private_key', '6LcKLc0SAAAAACNsGeX5H9cV0BDFSX3yxuogBR5v');
  variable_set('recaptcha_public_key', '6LcKLc0SAAAAAOrMECq3Jg-MEQY38oHYED4VKNyz');
